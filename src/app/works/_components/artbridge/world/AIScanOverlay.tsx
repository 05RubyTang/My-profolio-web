...
export default function AIScanOverlay({
  ...
  return (
    <div className="relative w-full h-full flex flex-col items-center justify-center">
      ...
      >
        <Sparkles size={11} className="text-[#C89BFF]" />
      ...
      >
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(180deg, rgba(200,155,255,0.08) 0%, rgba(200,155,255,0.02) 100%)",
        ...
        <motion.div
          ...
          style={{
            background:
              "linear-gradient(90deg, rgba(200,155,255,0) 0%, rgba(200,155,255,0.9) 50%, rgba(200,155,255,0) 100%)",
            boxShadow: "0 0 12px 2px rgba(200,155,255,0.6)",
          }}
          initial={{ top: "8%" }}
          animate={{ top: ["8%", "88%", "8%"] }}
          transition={{
        ...
        >
          {WORLD_ITEM_TAGS.map((tag, i) => (
            <motion.span
              ...
              style={{
                background:
                  "linear-gradient(135deg, rgba(200,155,255,0.35) 0%, rgba(247,128,199,0.35) 100%)",
