        ...
        return (
          <motion.button
            ...
            className={[
              ...
              isActive
                ? "bg-white/[0.08] border-[#FFB0DE]/60 shadow-[0_10px_40px_-10px_rgba(255,176,222,0.35)]"
          ...
          >
            ...
            <div className="flex items-center gap-2 mb-3">
              <span
                className={
                  isActive ? "text-[#FFB0DE]" : "text-white/60 group-hover:text-[#FFB0DE] transition-colors"
                }
              >
                {entry.icon}
              </span>
            ...
            >
              {entry.title}
              {entry.ready ? (
                <span className="ml-2 inline-flex items-center align-middle text-[10px] tracking-widest text-[#FFB0DE]/90 border border-[#FFB0DE]/40 rounded-full px-1.5 py-[1px]">
                  DEMO
                </span>
              ) : (
            ...
            <motion.div
              ...
              animate={{
                background: isActive
                  ? "linear-gradient(90deg, transparent, #FFB0DE, transparent)"
                  : "transparent",
